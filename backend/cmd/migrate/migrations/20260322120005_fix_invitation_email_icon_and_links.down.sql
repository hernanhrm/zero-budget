-- Revert invitation email template to original with emoji icon and plain email text.
                    ...
                    <td style="background-color:#2d2d2d;padding:16px;">
                      <table cellpadding="0" cellspacing="0"><tr>
                        ...
                        <td style="padding-left:12px;vertical-align:middle;">
                          ...
                          <span style="display:block;color:#6B6B6B;font-family:''IBM Plex Mono'',monospace;font-size:11px;letter-spacing:1px;">{{.InviterEmail}}</span>
                        </td>
                      </tr></table>
                    </td>
                  </tr></table>
...
WHERE event = 'organization.invitation_created'
