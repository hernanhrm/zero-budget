...
import (
	"backend/core/auth/api_route/adapter/handler"
	"backend/core/auth/api_route/adapter/postgres"
	"backend/core/auth/api_route/core"
	"backend/core/auth/api_route/port"
