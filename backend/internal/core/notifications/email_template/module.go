...
import (
	"backend/core/notifications/email_template/adapter/handler"
	"backend/core/notifications/email_template/adapter/postgres"
	"backend/core/notifications/email_template/core"
